...
class vector
{
   public:
      ...
      typedef typename  reverse_iterator<iterator>::reverse_iterator reverse_iterator;
      typedef typename  reverse_iterator<iterator>::const_reverse_iterator const_reverse_iterator;
